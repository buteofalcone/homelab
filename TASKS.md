...
- [x] Deploy Radarr with `/data/media/Movies` and hardlink-capable qBittorrent integration
- [x] Deploy Seerr with Jellyfin, Sonarr, and Radarr integration
- [x] Configure and validate the built-in Toloka.to Prowlarr indexer without committing credentials
