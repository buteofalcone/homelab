...
.PHONY: help bootstrap host-bootstrap recovery-preflight validate install base apps nextcloud immich jellyfin beszel-agent timemachine timemachine-bootstrap \
